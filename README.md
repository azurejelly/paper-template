# Paper Template
A Minecraft server plugin template using [Google Guice](https://github.com/google/guice). Looking for a multi module template? Check [this branch](https://github.com/azurejelly/paper-template/tree/multi-module) out.
